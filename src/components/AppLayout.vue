  ...
  <div class="app-layout">
    <header class="topbar">
      ...
      <nav class="topbar-nav">
        ...
        <div class="topbar-links-desktop">
          <router-link to="/dashboard" class="topbar-link">Dashboard</router-link>
          <router-link to="/clientes" class="topbar-link">Clientes</router-link>
    ...
    <div v-if="menuOpen" class="mobile-menu" @click="menuOpen = false">
      <nav class="mobile-menu-nav" @click.stop>
        <router-link to="/dashboard" class="mobile-menu-link" @click="menuOpen = false">Dashboard</router-link>
        <router-link to="/clientes" class="mobile-menu-link" @click="menuOpen = false">Clientes</router-link>
